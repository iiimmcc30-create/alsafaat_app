...
export const PLANS: SubscriptionPlan[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { text: '3 featured listings', arabic: '٣ إعلانات مميزة', included: true, highlight: true },
  ...
  },
  {
    ...
    features: [
      ...
      { text: 'Unlimited live streaming', arabic: 'بث مباشر غير محدود', included: true, highlight: true },
