    ...
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
          ...
          {[
            ...
            <View key={i} style={styles.featureRow}>
              <View style={styles.featureIcon}>
                <MaterialCommunityIcons name={item.icon as any} size={20} color={colors.electricBright} />
              </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.infoCard}>
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoValue}>MAD UNIT</Text>
            </View>
            <View style={styles.divider} />
            <View style={styles.infoRow}>
              <Text style={styles.infoLabel}>السجل التجاري</Text>
              <Text style={styles.infoValue}>مسجّل لدى وزارة التجارة السعودية</Text>
            </View>
            <View style={styles.divider} />
            <View style={styles.infoRow}>
        ...
        <View style={styles.section}>
          ...
          >
            <Ionicons name="mail-outline" size={20} color={colors.electricBright} />
          ...
          >
            <Ionicons name="globe-outline" size={20} color={colors.electricBright} />
            <Text style={styles.contactText}>alsfat.com</Text>
          </Pressable>
        </View>

        <Text style={styles.version}>SAFAT v1.0.0 · الصفاة · جميع الحقوق محفوظة © 2024</Text>
