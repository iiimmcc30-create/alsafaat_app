...
const SUGGESTED_HASHTAGS = [
  '#إبل', '#خيول', '#أغنام', '#صقور', '#مزاد', '#الصفاة', '#سوق_الخليج', '#ماشية',
];
      ...
      >
        ...
        <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
          ...
          <Pressable style={styles.audienceRow}>
            <Ionicons name="earth" size={14} color={colors.electricBright} />
            <Text style={styles.audienceText}>الجميع يمكنهم الرد</Text>
            <Ionicons name="chevron-down" size={14} color={colors.electricBright} />
          </Pressable>
          ...
          <View style={styles.toolbarLeft}>
            {[
              ...
              <Pressable key={tool.icon} style={styles.toolBtn} hitSlop={8}>
                <Ionicons name={tool.icon as any} size={20} color={colors.electricBright} />
              </Pressable>
            ))}
          </View>
