      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 160 }}>
        ...
        <View style={styles.body}>
          ...
          <View style={styles.locationRow}>
            <Ionicons name="location" size={18} color={colors.electricBright} />
              ...
              <View style={styles.ownerBtns}>
                ...
                <View style={styles.ownerSecondRow}>
                  <Pressable onPress={handleEdit} style={styles.ownerSecBtn}>
                    <Ionicons name="create-outline" size={18} color={colors.electricBright} />
            ...
            <View style={{ flex: 1 }}>
              <View style={styles.sellerNameRow}>
                ...
                {listing.seller.verified ? (
                  <Ionicons name="shield-checkmark" size={16} color={colors.electricBright} />
                ) : null}
              </View>
