        ...
        {activeTab === 'fees' && (
          <>
            ...
            {pendingFees.length > 0 && (
              <View style={styles.bulkRow}>
                <Pressable onPress={selectAll} style={styles.selectAllBtn}>
                  <Ionicons name="checkmark-done" size={14} color={colors.electricBright} />
            ...
            <View style={styles.infoBox}>
              <Ionicons name="information-circle-outline" size={16} color={colors.glow} />
            ...
            {subscription.planId !== 'vip' && (
              ...
              >
                <LinearGradient colors={['#7C3AED', '#A855F7']} style={styles.upgradeBtnInner}>
                  ...
                  <Ionicons name={rtlForwardIcon} size={16} color="#fff" />
                </LinearGradient>
              </Pressable>
            )}
        ...
        <View style={styles.modalBackdrop}>
          ...
          <View style={styles.modal}>
            ...
            <View style={styles.niBadge}>
              <MaterialCommunityIcons name="lock" size={12} color={colors.textSubtle} />
