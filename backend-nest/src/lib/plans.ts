// src/lib/plans.ts — subscription plan catalog (single source of truth for API + payments)
...
export const PLANS: SubscriptionPlan[] = [
  {
    ...
    color: '#334155',
    colorEnd: '#1E293B',
    description: 'Start trading on Sarouh',
    ...
    features: [
      {
        text: '5 listings per month',
        arabic: '٥ إعلانات شهريًا',
        included: true,
      },
      {
        text: 'Up to 3 photos per listing',
        arabic: '٣ صور لكل إعلان',
        included: true,
      },
      {
        text: 'Standard market visibility',
        arabic: 'ظهور عادي في السوق',
        included: true,
      },
  ...
  },
  {
    ...
    features: [
      {
        text: '15 listings per month',
        arabic: '١٥ إعلانًا شهريًا',
        included: true,
      },
      {
        text: 'Up to 8 photos per listing',
        arabic: '٨ صور لكل إعلان',
        included: true,
      },
      {
        text: 'Better search visibility',
        arabic: 'ظهور أفضل في البحث',
        included: true,
      },
      {
        text: '1 featured listing per week',
        arabic: 'إعلان مميز أسبوعيًا',
        included: true,
        highlight: true,
      },
      {
        text: 'Live stream 60 min/week',
        arabic: 'بث مباشر ٦٠ دقيقة أسبوعيًا',
        included: true,
        highlight: true,
      },
  ...
  },
  {
    ...
    features: [
      {
        text: '30 listings per month',
        arabic: '٣٠ إعلانًا شهريًا',
        included: true,
      },
      {
        text: 'Up to 15 photos per listing',
        arabic: '١٥ صورة لكل إعلان',
        included: true,
      },
      {
        text: '3 featured listings',
        arabic: '٣ إعلانات مميزة',
        included: true,
        highlight: true,
      },
      {
        text: '1 pinned listing',
        arabic: 'تثبيت إعلان واحد',
        included: true,
        highlight: true,
      },
      {
        text: 'Live stream 120 min/week',
        arabic: 'بث مباشر ١٢٠ دقيقة أسبوعيًا',
        included: true,
        highlight: true,
      },
      {
        text: 'Priority search placement',
        arabic: 'أولوية الظهور في البحث',
        included: true,
      },
    ...
    features: [
      {
        ...
        arabic: 'إعلانات غير محدودة',
        included: true,
        highlight: true,
      },
      { text: 'Unlimited photos', arabic: 'صور غير محدودة', included: true },
      {
        text: 'All listings pinned & featured',
        arabic: 'تثبيت وتمييز جميع الإعلانات',
        included: true,
        highlight: true,
      },
      {
        text: 'Verified account badge',
        arabic: 'حساب موثق رسميًا',
        included: true,
        highlight: true,
      },
      {
        text: 'Unlimited live streaming',
        arabic: 'بث مباشر غير محدود',
        included: true,
        highlight: true,
      },
      {
        text: 'Dedicated account manager',
        arabic: 'مدير حساب مخصص',
        included: true,
      },
      {
        text: 'All Pro features included',
        arabic: 'جميع مميزات الباقات الأخرى',
        included: true,
      },
    ],
  },
...
export const UPGRADABLE_PLANS: PlanId[] = ['starter', 'pro', 'vip'];
