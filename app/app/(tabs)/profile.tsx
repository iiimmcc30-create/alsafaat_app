...
export default function ProfileScreen() {
  ...
  const { me, listings, updateMe } = useApp();
  ...
  const openConnections = (tab: 'followers' | 'following') => {
    router.push({
      ...
      params: { userId: me.id, tab, username: me.username },
    } as never);
  };
      ...
      >
        <View style={styles.heroSection}>
          <View style={styles.coverWrap}>
            {me.coverImage ? (
              <Image source={{ uri: me.coverImage }} style={styles.coverImage} contentFit="cover" />
            ) : (
              <LinearGradient
            ...
            <View style={styles.aboutCard}>
              {[
                ...
                },
                {
                  ...
                  label: 'يتابع',
                  value: me.following.toLocaleString('ar-SA'),
                },
              ].map((item, idx, arr) => (
                <View
                  key={item.label}
