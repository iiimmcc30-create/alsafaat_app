...
const TERMS = [
  {
    ...
    content: `باستخدامك منصة سروح فإنك توافق على الالتزام بهذه الشروط والأحكام. إن كنت لا توافق على أي بند منها، يُرجى عدم استخدام المنصة.`,
  },
  {
    title: 'شروط التسجيل',
  ...
  },
  {
    ...
    content: `المنصة وسيلة للتواصل بين البائعين والمشترين فقط. لا تكون سروح طرفاً في أي صفقة بين المستخدمين. أي نزاع تجاري هو مسؤولية الأطراف المتعاقدة مباشرة.`,
  },
  {
  ...
  },
  {
    ...
    content: `تُقدَّم المنصة "كما هي" دون ضمانات صريحة أو ضمنية. لا تتحمل سروح أو مؤسسة ماد يونيت للتجارة مسؤولية أي خسائر تنتج عن استخدام المنصة أو المعاملات المُبرمة عبرها.`,
  },
  {
  ...
  return (
    <SafeAreaView style={styles.container} edges={['top']}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scroll}>
        ...
        <Text style={styles.footer}>© 2024 مؤسسة ماد يونيت للتجارة · سروح · جميع الحقوق محفوظة</Text>
